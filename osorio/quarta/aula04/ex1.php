...
<body>
	...
	// verificar se botão 'enviar' foi submetido (pressionado / enviado)
	if (isset($_POST['enviar']))
	{
		// se a condição acima for verdadeira, então, armazenamos os valores
		// dos campos do form nas respectivas variáveis
		$nome   = $_POST['nome'];
		$altura = $_POST['altura'];

		// verificar se o valor da altura é maior ou igual 1 E
		// se o valor da altura é menor ou igual a 159
		/*
		...
		*/
		...
		echo "<p>$nome, você tem $altura cm de altura, portanto, sua estatura
		 é $estatura</p>";
